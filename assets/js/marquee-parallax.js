(() => {
  ...
  const render = () => {
    ...
    if (reduceMotion.matches) {
      primary.style.translate = 'none';
      secondary.style.translate = 'none';
      return;
    }
    ...
    primary.style.translate = `${primaryX.toFixed(2)}px 0`;
    secondary.style.translate = `${secondaryX.toFixed(2)}px 0`;
  };
